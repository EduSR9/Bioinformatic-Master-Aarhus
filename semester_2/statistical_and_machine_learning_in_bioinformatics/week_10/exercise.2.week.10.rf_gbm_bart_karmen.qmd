...
## Q2.2: Make a plot with tree number on the x-axis and estimated mse on the y-axis.
...
What happens if you use all off them? (bagging) What happens if you use very few (10%) of the predictors for each split?
...
You will have to google and read about lightGBM. Or use AI to find out what it is.

It's currently the package that a lot of people use for tree based predicions. Why? Try it to find out.
